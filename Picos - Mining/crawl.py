...
consumer_key        = 'dl9Sg52mOinq6heqiI8D0mZre'
consumer_secret     = '2qmI9x9kJsVqkc5AsGQvPzZLfjhP9huOD1gsJOkinwVZjadFyo'
access_key          = '829344089829158914-vMpvvHz2XNu0dBayI6TkQLPxkeHk1KL'
access_secret       = 'WMqA2xagTHWfSxTElX59DrA60lXUMHlFjxw90jjmYw9dn'


twitter = Twitter(auth = OAuth(access_key, access_secret,consumer_key, consumer_secret))
Saida = open("DATA_SET_PICOS.json","a")

result_count = 0
last_id =  get_Last_id("DATA_SET_PICOS.json")
